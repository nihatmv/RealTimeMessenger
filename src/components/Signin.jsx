    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-black to-purple-200">
      ...
      >
        ...
        <div className="flex mb-6 bg-gray-100 rounded-full p-1">
          <button
            type="button"
            className="w-1/2 py-2 rounded-full bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold shadow"
          >
            Login
          </button>
          <button
            type="button"
            className="w-1/2 py-2 rounded-full text-black font-semibold"
